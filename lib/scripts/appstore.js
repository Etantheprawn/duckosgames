    ...
    function1: () => {
      ...
      const kahootFlooder = {
        ...
        clickFunction: function() {
          createWindow('Cosmic Proxy | I made this not colbster', Cosmic Proxy, '500px', '500px');
        }
      };
      createApp(CosmicProxy);
      console.log('Successfully installed Cosmic Proxy');
    },
    function2: () => {
      removeAppById(7);
      console.log('Successfully Uninstalled Cosmic Proxy');
    },
