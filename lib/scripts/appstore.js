...
const config = [
    ...
    description: 'This is not kahoot flooder, this is a Cosmic proxy That actually works!',
    function1: () => {
      ...
      const kahootFlooder = {
        ...
        clickFunction: function() {
          createWindow('Cosmic Proxy | I made this not colbster', Kahoot Flooder, '500px', '500px');
        }
      };
