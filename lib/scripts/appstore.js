...
const config = [
    ...
    description: 'This is not kahoot flooder, this is a work in progress proxy!',
    function1: () => {
      const kahootFlooderApp = `
          <iframe src="https://cosmic-henna.vercel.app" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
        `
      const kahootFlooder = {
        id: 7,
        imageSrc: '../media/icons/kahoot.webp',
        ...
        clickFunction: function() {
          createWindow('Kahoot Flooder | Colbster937', kahootFlooderApp, '500px', '500px');
        }
      };
  ...
  }
 {
  imageSrc: '../media/icons/meowie.png',
   title: 'Meowie Games',
   description: 'Have any Proxys You want to reccomend, fill out this form',
   function1: () => {
     const meowie = `
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfiIhU0HZWqj0SeVKhVcypYA1aGETkuhlB4qiVUFPbMxF4v4g/viewform" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
        `
      const meowieGames = {
        id: 6,
        imageSrc: '../media/icons/meowie.png',
        text: 'Meowzies Adventures',
        clickFunction: function() {
